...
//
//   let conditions = try? newJSONDecoder().decode(Conditions.self, from: jsonData)
...
class WeatherCondition: Codable {
    ...
    init(code: Int, day: String, night: String, icon: Int, languages: [Language]) {
        self.code = code
        self.day = day
        self.night = night
        self.icon = icon
...
class Language: Codable {
    ...
    init(langName: LangName, langISO: LangISO, dayText: String, nightText: String) {
